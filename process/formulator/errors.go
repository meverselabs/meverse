...
var (
	...
	ErrInvalidAlphaPolicy                      = errors.New("invalid alpha policy")
	ErrInvalidSigmaPolicy                      = errors.New("invalid sigma policy")
	ErrInvalidOmegaPolicy                      = errors.New("invalid omega policy")
