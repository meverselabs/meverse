...
func (fr *ClientNode) sendRequestBlockTo(TargetID string, Height uint32, Count uint8) error {
...
func (fr *ClientNode) sendRequestBlockToNode(TargetPubHash common.PublicHash, Height uint32, Count uint8) error {
