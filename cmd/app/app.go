...
func (app *FletaApp) InitGenesis(ctw *types.ContextWrapper) error {
	...
	if p, err := app.pm.ProcessByName("fleta.vault"); err != nil {
		...
		totalDeligated := amount.NewCoinAmount(79387877, 387307476700000000)
		...
		addSigmaFormulator(sp, ctw, sigmaPolicy, alphaPolicy, common.MustParsePublicHash("3w1FJ5oBDtPHyviSDFNK9wR8fKQLysNp5iWU9ZQxmgB"), common.MustParsePublicHash("4a79juvuteekAtRdbZVboZXsWHM1dBsgbdDa1WR2Y1Z"), common.MustParseAddress("6XuA53cuPy"), "Hyewon Formulator")
		...
		addSigmaFormulator(sp, ctw, sigmaPolicy, alphaPolicy, common.MustParsePublicHash("3pNSjTs5ZJvgMYDg3o1uwgi4PhdgKuSDBxWmJgLt45o"), common.MustParsePublicHash("3LPH7aNkLdLU3gQnrtuKpxtHGct14JGJEHsQokKTASh"), common.MustParseAddress("4QpFLBMapk"), "S.B.Chung 1")
		...
		addSigmaFormulator(sp, ctw, sigmaPolicy, alphaPolicy, common.MustParsePublicHash("4GZM8GmY7DoPBRtuAGpk3yKmXdLb9Nwpcw2p9kYxDhK"), common.MustParsePublicHash("2t3haUJzDMXqYGPJRUHie86hSyLHUYNpZyziiVdHG2Z"), common.MustParseAddress("2SXG5EPvo9"), "Yongdae Kim")
		addSigmaFormulator(sp, ctw, sigmaPolicy, alphaPolicy, common.MustParsePublicHash("4GmYu27jXXmXNWX6FeD4WybGDRSsppjQByHJQtXiGyg"), common.MustParsePublicHash("311QvrZUYFaKisd97E9TtktkEWxxdfBpcVKmkv5uKXd"), common.MustParseAddress("9bw5ZuY8on"), "Yongdae Kim2")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("2gpStGSG4TQV64REcNky5ZESRx3gT2Ztijpvmn8axrF"), common.MustParsePublicHash("21EYQMzzjaeaxWpD6dCCG4tAcAKu9S6V3VnhhTU9m2Z"), common.MustParseAddress("7ZF8ZzveYJ"), "Jaein Formulator")
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("2u3HfbAbyJsTVYB3d9Mk4jJjvagCzQE6H6zbKLBWQr8"), common.MustParsePublicHash("rbqYYydgTG7fQasti7pWj4udw94cVCTRBFXD8MTs5j"), common.MustParseAddress("7SegxZSu5d"), "Eunu Formulator")
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("82bkE1yUoPgdjBEWv3fFjHKMMCCEsWvkVcGz7vfztu"), common.MustParsePublicHash("EDH8ctQQbspb4WvxDzP2pkss65DetV73VH1SdGyByh"), common.MustParseAddress("7HrmUe9EU7"), "Seojun Formulator")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("33eQFdQ72GFAitMYgHFHUjAatTiCjUJUS4NQiG2E1LC"), common.MustParsePublicHash("2neWYucSRyZoykUVUc1bWBaBkpBuBAJcms58KhcJdmm"), common.MustParseAddress("JaqxqcSG6"), "FLETA YW")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("4WQNnUZYQJBu51qswhJ9SWPLcbdwqdv6aF7phR9FjVH"), common.MustParsePublicHash("4kH5VLQwGSSFwTt9aCWufsHqn4QHM98xD6QfUtTJZcC"), common.MustParseAddress("6TWCL5y56D"), "two stars")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("3VcEsxBQb85jDnmwAbF26CYtcHwCCs3xH8e76dnLgvR"), common.MustParsePublicHash("42AUcV2aJL2zRRnCiwPjeFpyJcaeMkLMjvas1vfwMPq"), common.MustParseAddress("8qyUAK1oj6"), "Hangki Choi")
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("332vLWXv7Hurhc9cDTuKppgHEHmndSWdTd9mGcHffA"), common.MustParsePublicHash("4ryTKVCHxeUv4VRVGZP8p8UTqMtxw7uHbqVZA48W7z6"), common.MustParseAddress("8maWRMMyRL"), "Choi Hangki")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("4bK2XwwqX3azrfZ3TXvJ1sS9LWSp2dohaX2dHHHRtsw"), common.MustParsePublicHash("gQe99ADqgHwtJcqaragD8UYmr1QRTsWZ3uBk1oPVuS"), common.MustParseAddress("7FfHcAKKKG"), "HYUNG JOON KIM")
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("2U3JkoLcftEaVaqQCzV1zxUhX6FYjYSaYPMh8iJscDR"), common.MustParsePublicHash("HMLUh6TnWYZFnCzU4CVmU1sxkKmcBeRse4CWYzoyx6"), common.MustParseAddress("7pdVfMi4cy"), "HHYUNG JOON2")
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("3TdmR7dAHXoHR54UdB2ezu9uFTEGrLKb9GbC7iVvYuv"), common.MustParsePublicHash("3NvsdB7sr9oKuuLCPA5KGmXFF6RAcJFAZXGSQHbwwZn"), common.MustParseAddress("7i343vEKAN"), "HYUNG JOON3")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("gyrwaGGdRx4aK8MavgtojjVhhG2JqNNobBdZka4BHa"), common.MustParsePublicHash("mafMWZFa6yzzzSFEfbuAELGe2tyhWgsgjGc7GdPe5"), common.MustParseAddress("6qV12tEEmf"), "STL Fomul")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("2NwXhbFKzpZ9T3zmeywvjBQ6uivaE8bEsKFmeMVKd2W"), common.MustParsePublicHash("3ZM531GpT4aRq1s7dZmrVXhrwv1iJFcd8BksCtFgv5E"), common.MustParseAddress("9yutGhoJLa"), "Shin Junghoon")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("3spa3vRy6LLbdDhEsmSGx34xcU5mxWgnNAR9ugKn1dH"), common.MustParsePublicHash("35MHgw3QQcBXTXiL3GSgyVpZxYShAnGW6BZewTUcydA"), common.MustParseAddress("3TsEaBhg4g"), "glory of fomulator")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("4NQApXbUFLtfvwHKV7GVFUYBLWDVBd1zbZggEHkRJXp"), common.MustParsePublicHash("Cu1rAXpzj5BLtTDBWHHqWfcD31Ysrve7qXBahZKr1i"), common.MustParseAddress("4iQ6J1xv4L"), "Forour Eddy")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 5184000, common.MustParsePublicHash("49h21RPKJ8GpWFfFKHcuV8TcrsHFzZhejxZAC3pwBRS"), common.MustParsePublicHash("3Piff52ULgP6PDRYQ34aqBKXaQwNWgL9thssqgtD18W"), common.MustParseAddress("22LyVxJrBM"), "ctrl Z")
		...
		addAlphaFormulator(sp, ctw, alphaPolicy, 113360, common.MustParsePublicHash("Q4RqLBPtz47PcmWq9GvwX5g4pNAJKiyXrmtvaRq6EA"), common.MustParsePublicHash("2WxprTRTi12tbV5hhMD98VFy4JXjSwvdkUawvkV8yLq"), common.MustParseAddress("6sgUuN49va"), "STL Lee")
	...
	if p, err := app.pm.ProcessByName("fleta.formulator"); err != nil {
		...
		addStaking(fp, ctw, common.MustParseAddress("GPN6MnU3y"), common.MustParseAddress("31VU8Rnj43"), amount.NewCoinAmount(4500000, 0))
		addStaking(fp, ctw, common.MustParseAddress("GPN6MnU3y"), common.MustParseAddress("3W4iSfXe3Y"), amount.NewCoinAmount(4500000, 0))
		...
		addStaking(fp, ctw, common.MustParseAddress("9nvUvJibL"), common.MustParseAddress("9yutGhoMJX"), amount.NewCoinAmount(10000, 0))
		addStaking(fp, ctw, common.MustParseAddress("9nvUvJibL"), common.MustParseAddress("9yutGhoMJX"), amount.NewCoinAmount(90000, 0))
		...
		addStaking(fp, ctw, common.MustParseAddress("GPN6MnU3y"), common.MustParseAddress("5jk4nyGiEV"), amount.NewCoinAmount(400000, 0))
		...
		addStaking(fp, ctw, common.MustParseAddress("9nvUvJibL"), common.MustParseAddress("7HrmUe9Hag"), amount.NewCoinAmount(35999, 0))
		...
		addStaking(fp, ctw, common.MustParseAddress("9nvUvJibL"), common.MustParseAddress("8YPdCUQXdh"), amount.NewCoinAmount(168098, 02))
		addStaking(fp, ctw, common.MustParseAddress("9nvUvJibL"), common.MustParseAddress("3t3X9TnoaY"), amount.NewCoinAmount(13400, 72518335))
	}
	return nil
}
